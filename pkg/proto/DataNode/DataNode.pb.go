...
type Book struct {
	...
	//	*Book_Name
	//	*Book_Chunks
	Data                 isBook_Data `protobuf_oneof:"data"`
...
type Book_Chunks struct {
	Chunks []byte `protobuf:"bytes,2,opt,name=chunks,proto3,oneof"`
}

func (*Book_Name) isBook_Data() {}

func (*Book_Chunks) isBook_Data() {}

func (m *Book) GetData() isBook_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *Book) GetName() string {
	if x, ok := m.GetData().(*Book_Name); ok {
		return x.Name
	}
	return ""
}
...
func (m *Book) GetChunks() []byte {
	if x, ok := m.GetData().(*Book_Chunks); ok {
		return x.Chunks
	}
	return nil
}
...
var fileDescriptor_2cc4c9d8f36887fb = []byte{
	...
	,
}
